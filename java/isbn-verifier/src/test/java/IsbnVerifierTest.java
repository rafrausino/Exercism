...
public class IsbnVerifierTest {
    ...
    @Test
    public void validIsbnNumber() { assertTrue(isbnVerifier.isValid("3-598-21508-8")); }

    //@Ignore("Remove to run test")
    @Test
    public void invalidIsbnCheckDigit() { assertFalse(isbnVerifier.isValid("3-598-21508-9")); }

  //  @Ignore("Remove to run test")
    @Test
    public void validIsbnNumberWithCheckDigitOfTen() { assertTrue(isbnVerifier.isValid("3-598-21507-X")); }
